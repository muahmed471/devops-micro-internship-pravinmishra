...
Demonstrate understanding of AWgit fetch origin
git log --oneline --graph --decorate --all --simplify-by-decoration -20S basics and Free Tier usage by answering the following questions in your own words (3–4 lines each).
